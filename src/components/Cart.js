        ...
        {!isCartEmpty && (
          ...
          <div className = " m-2 flex justify-between">
            ...
            <div className= " m-1">
              ...
              <div className= " m-1">
              <ul>
                <li className="text-xs font-normal text-gray-500"> ₹300</li>
                <li className="text-xs font-normal text-gray-500"> ₹49</li>
                <li className="text-xs font-normal text-gray-500"> -₹100</li>
                <li className="text-xs font-normal text-gray-500"> ₹10</li>
                <li className="text-xs font-normal text-gray-500"> ₹50</li>
              </ul>
              </div>
            </div>
            ...
            <div className = " m-2 flex justify-between">
              ...
              <div className="m-1">
              <ul>
                  <li className = "text-sm font-semibold">₹309 </li>
                </ul>
              </div>
            </div>
          ...
          {isModalOpen && (
                  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-slate-100 font-serif p-6 rounded shadow-lg mx-auto text-center">
                      ...
                      <p className="text-sm">Thanks for ordering from us !</p>
                      <button
